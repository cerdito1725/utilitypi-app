...
def main():
    ...
    template_svg_filename = f'/home/neal/scripts/waveshare/screen-template.{template_name}.svg'
    output_svg_filename = '/home/neal/scripts/waveshare/screen-output-weather.svg'
